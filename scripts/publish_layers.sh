...
RUBY_VERSIONS_FOR_AWS_CLI=("ruby3.2" "ruby3.2")
LAYER_PATHS=(".layers/datadog-lambda_ruby-amd64-3.2.zip" ".layers/datadog-lambda_ruby-arm64-3.2.zip")
AVAILABLE_LAYERS=("Datadog-Ruby3-2" "Datadog-Ruby3-2-ARM")
